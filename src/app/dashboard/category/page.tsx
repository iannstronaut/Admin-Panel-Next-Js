...
import getCategories, { CategoryResponse } from "./service";
...
export default function CategoryPage() {
  ...
  const [content, setContent] = useState<CategoryResponse>();
  ...
  useEffect(() => {
    const result = getCategories(page, limit);
    setContent(result);
  }, [page, limit]);
